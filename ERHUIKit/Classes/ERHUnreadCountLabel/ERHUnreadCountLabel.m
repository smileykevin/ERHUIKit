...
#import "ERHUnreadCountLabel.h"

#import <Masonry/Masonry.h>

/// 默认的未读 Label 高度，该高度与系统 TabBar 上的未读高度一致
CGFloat const kERHUnreadCountLabelDefaultHeight = 18.0;
/// 默认未读数量字体大小
CGFloat const kERHUnreadCountLabelDefaultFontSize = 13.0;


@interface ERHUnreadCountLabel ()

/// 未读 Label 在父视图上的位置
@property (nonatomic, assign) ERHUnreadCountLabelPosition position;
...
@implementation ERHUnreadCountLabel

#pragma mark - init Methods
- (instancetype)initWithPosition:(ERHUnreadCountLabelPosition)position {
    self = [super init];
    if (self) {
        ...
        self.font = [UIFont systemFontOfSize:kERHUnreadCountLabelDefaultFontSize];
        self.layer.masksToBounds = YES;
        self.unreadCountLabelHeight = kERHUnreadCountLabelDefaultHeight;
        self.unreadCountLabelCornerRadius = kERHUnreadCountLabelDefaultHeight / 2;
    }
    return self;
}
...
- (void)configUnreadCountLabelWithSuperViewFrame:(CGRect)frame {
    ...
    [self mas_remakeConstraints:^(MASConstraintMaker *make) {
        switch (self.position) {
            case ERHUnreadCountLabelPositionTopRight: {
            ...
            case ERHUnreadCountLabelPositionRight:
